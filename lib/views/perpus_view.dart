...
import 'package:perpus_/controllers/perpus_controller.dart';
import 'package:perpus_/models/perpus.dart';
        ...
        actions: [
          TextButton(
            ...
            onPressed: () {
              ...
              setState(() {
                _controller.editBuku(index, updatedBuku);
              });
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final buku = _controller.getBukuList()[index];
                  return ListTile(
                    leading: Image(image: AssetImage("Assets/" + buku.cover)),
